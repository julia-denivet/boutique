...
<html>
	...
	<body>
		...
		<main id="modif_produit">
			<h1 class="titre_admin"><?php echo $data['nom']; ?></h1>
			<div class="admin_gestion_produit">
				<form method="post" enctype="multipart/form-data">
					...
					<input type="text" name="stock" value="<?php echo $data['stock']; ?>" step="0.01" placeholder="Stock"/>
				...
				<?php
					...
					{
						$var->modif_produit($_POST['id_produit'], $_POST['modifier_produit'], $_POST['nom'], $_POST['description'], $_POST['sous_categorie'], $_POST['prix_ht'], $_POST['prix_ttc'], $_POST['stock'], $_FILES['image']['tmp_name'], $_FILES['image']['type'], $_FILES['image']['name']);
					}
				?>
			</div>
		</main>
